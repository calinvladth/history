    ...
    render() {
        return (
            <div>
                ...
                <p className={style.subtitle}><strong>What Are Cookies</strong></p>
                ...
                <p className={style.subtitle}><strong>How We Use Cookies</strong></p>
                ...
                <p className={style.subtitle}><strong>Disabling Cookies</strong></p>
                ...
                <p className={style.subtitle}><strong>The Cookies We Set</strong></p>
                ...
                <p className={style.subtitle}><strong>Third Party Cookies</strong></p>
                ...
                <p className={style.subtitle}><strong>More Information</strong></p>
                ...
                <ul>
                    <li className={style.email}>Email: thegoodworld.live@gmail.com</li>
