    ...
    render() {
        return (
            <div>
                ...
                <h2 className={style.subtitle}>How we use your information</h2>
                ...
                <h2 className={style.subtitle}>Log Files</h2>

                <p>Thegoodworld follows a standard procedure of using log files. These files log visitors when they visit
                ...
                <h2 className={style.subtitle}>Cookies and Web Beacons</h2>

                <p>Like any other website, thegoodworld uses 'cookies'. These cookies are used to store information
                ...
                <h2 className={style.subtitle}>Advertising Partners Privacy Policies</h2>
                ...
                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                    are used in their respective advertisements and links that appear on thegoodworld, which are sent
                ...
                <p>Note that thegoodworld has no access to or control over these cookies that are used by third-party
                    advertisers.</p>

                <h2 className={style.subtitle}>Third Party Privacy Policies</h2>

                <p>Thegoodworld's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
                ...
                <h2 className={style.subtitle}>CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
                ...
                <h2 className={style.subtitle}>GDPR Data Protection Rights</h2>
                ...
                <p>Thegoodworld does not knowingly collect any Personal Identifiable Information from children under the
